...
private:
	...
	D3DXMATRIXA16					m_matCorrectPosition;
	// <<
public:
	cXMesh_Skinned(void);
	~cXMesh_Skinned(void);
	...
	void UpdateCorrectMatrix() {
		BONE* pBone = (BONE*)m_pRootbone->pFrameFirstChild;
		D3DXMatrixIdentity(&m_matCorrectPosition);
		m_matCorrectPosition._41 = -pBone->TransformationMatrix._41;
		m_matCorrectPosition._42 = -pBone->TransformationMatrix._42;
		m_matCorrectPosition._43 = -pBone->TransformationMatrix._43;
	}
private:
...
public:
	...
	UINT GetAnimNum() { return m_AnimNum; }
	VEC_ANIMSET GetAnimSet() { return m_vecAnimSet; }
};
