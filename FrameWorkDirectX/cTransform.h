...
public:
	...
	void CorrectionUp(const D3DXVECTOR3& _up, float angle);
	...
	void SetAxises(D3DXVECTOR3 * axis)
	...
	void SetAxisUp(D3DXVECTOR3 _up)
	{
		this->axis[1] = _up;
